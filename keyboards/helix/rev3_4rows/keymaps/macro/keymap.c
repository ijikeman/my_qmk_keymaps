...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * | CAPS |      | LANG | ALT  |  GUI | LOWER|Space |Space | RAISE| LANG |ADJUST|      |      |      |
   * `-------------------------------------------------------------------------------------------------'
   */
[_QWERTY] = LAYOUT(
  ...
  KC_CAPS, KC_NO, MLANG1, KC_LALT, KC_LGUI,LOWER,KC_SPC,KC_SPC,RAISE,MLANG2,ADJUST, KC_NO,  KC_NO,   KC_NO
),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |   ~  |   !  |   @  |   #  |   $  |   %  |             |   ^  |   &  |   *  |   (  |   )  |  _/+ |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |      |      |      |             | LEFT | DOWN |  UP  | RGHT |L-CLCK|R-CLCK|
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |      |      |      |      |      |             |      | WIN_L|WIN_T |WIN_R |WHEELD|WHEELU|
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      | DEL  |      |      |      |      |RESET |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_LOWER] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                   KC_LEFT, KC_DOWN,  KC_UP,  KC_RGHT, MS_BTN1, MS_BTN3,
      _______, _______, _______, _______, _______, _______,                   _______,WIN_LEFT,WIN_TAB, WIN_RGHT, MS_WHLD, MS_WHLU,
